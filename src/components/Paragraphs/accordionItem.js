...
class AccordionItem extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="pb-4">
        <div>
          <button className="block h4 text-blue hover:text-green-dark focus:text-green-dark mb-2" onClick={this.toggle.bind(this)} aria-controls={`accordion-${this.props.id}`} aria-expanded={String(shown)}>
            {this.props.header}
          </button>
        </div>
